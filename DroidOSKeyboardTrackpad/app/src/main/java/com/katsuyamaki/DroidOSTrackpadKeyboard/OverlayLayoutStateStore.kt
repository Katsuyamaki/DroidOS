...
internal class OverlayLayoutStateStore(private val service: OverlayService) {
    ...
    fun saveLayout() {
        ...
        val saveDockMode = dockSavePrefs.getBoolean("dock_mode_d${service.currentDisplayId}$dockOs", dockSavePrefs.getBoolean("dock_mode_d${service.currentDisplayId}", dockSavePrefs.getBoolean("dock_mode", true)))
        val saveAutoShow = dockSavePrefs.getBoolean("auto_show_overlay$displaySuffix$dockOs", dockSavePrefs.getBoolean("auto_show_overlay$displaySuffix", dockSavePrefs.getBoolean("auto_show_overlay$dockOs", dockSavePrefs.getBoolean("auto_show_overlay", true))))
        val saveAutoResize = dockSavePrefs.getBoolean("auto_resize$displaySuffix$dockOs", dockSavePrefs.getBoolean("auto_resize$displaySuffix", dockSavePrefs.getBoolean("auto_resize$dockOs", dockSavePrefs.getBoolean("auto_resize", true))))
