...
/**
 * Adapter for the visual queue HUD overlay.
 * Shows app icons with slot numbers for keyboard navigation.
 */
class VisualQueueAdapter(
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        val pendingArg1 = actionHandler.getPendingArg1()
        
        // Focus underline logic
        ...
        holder.badge.setScaledTextSize(currentFontSize, 0.625f)
        ...
        holder.itemView.setOnClickListener {
            actionHandler.handleCommandInput(slotNum)
        }
    }
