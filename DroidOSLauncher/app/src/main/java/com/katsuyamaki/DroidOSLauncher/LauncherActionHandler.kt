...
interface LauncherActionHandler {
    ...
    fun selectLayout(option: FloatingLauncherService.LayoutOption)
    fun loadProfile(name: String)
    fun saveProfile()
    fun applyResolution(option: FloatingLauncherService.ResolutionOption)
    fun pickIcon()
    ...
    fun getQueueCommandPending(): FloatingLauncherService.CommandDef?
